	...
	<img src="img/sipep.png"/>
      ...
      <h3>Tips para una Entrevista Laboral</h3>
		...
		<ul align="justify">
                    ...
                    <div class="col-lg-6">
                        <!--img scr="img/queNoHacer.PNG"/-->
                        <h3>Que no hacer:</h3>
                <ul align="justify">
                    <li>¡No llegues tarde!</li>
		...
		<!--<table><tr><td><img class="img-rounded img-responsive" src="img/queHacer.jpg"/></td></tr>
		<tr><td></td><img  class="img-rounded img-responsive" src="img/queNoHacer.png"/></tr></table>
